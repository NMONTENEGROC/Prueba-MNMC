...
/*.texto{border:none;}*/
    ...
    <div id="Area_Impresion" style="width:720px;background-color:#FFF;margin:0;margin-left:2.5%;margin-top:2.5%;border:2px #000000 solid;border-radius:15px;">
        ...
        <div id="TUPLAS" style="background-color:#FFF;width:98.3%;margin:0.5%;margin-top:240px;z-index:2;border:#003300 dashed 1px;border-radius:15px;padding:3px;">           <table width="98%" style="padding:1%;margin-left:1.3%;font-family:Lucida Sans Unicode;color:#000;border-collapse: collapse;" id="generar">
            	<tr style="width:100%;background: -webkit-gradient(linear, 0% 0%, 0% 100%, from(#9bbb40), to(#1e5b15));background: -moz-linear-gradient(top, #9bbb40, #1e5b15);">
                    ...
                    <td style="width:50%; text-align:center;padding-left:2%;border-top-right-radius:15px;">
                    	OBSERVACIONES
                    </td>
                </tr>  
                <?php 
				...
				?>
                    ...
                    <td style="padding-left:2%;border:#003300 dashed 1px"><?php echo $datos['OBSERVACIONES']; ?></td>
                    </tr>
                 <?php  
				 	$clase=$clase+1;					
					}
