    ...
    <div id="barra_horizontal" style="">
    	 <ul id="lista" name="lista" style="">
                    ...
                    <li style="margin-top:0px;float:top;position:absolute;"> <a href="">Hotel</a>
                        <ul>
                            <a href="admin/Bloque.Options.php"><li>Bloque</li></a>
                            <a href="admin/Habitaciones.Options.php"><li>Habitación</li></a>
                            <a href="admin/Elementos.Options.php"><li>Elementos</li></a>
                            <a href="admin/Productos.Options.php"><li>Productos</li></a>
                            <a href="admin/Inventario.Options.php"><li>Inventario</li></a>
                        </ul>
                    </li>
                    <li style="margin-top:0px;position:absolute;margin-left:16.7%;"> <a href="">Reservas</a> 
                       <ul>
                            <a href="admin/Huesped.Options.php"><li>Huésped</li></a>
                            <a href="admin/Reserva.Options.php"><li>Reserva</li></a>
                        </ul>
                    </li>
                    <li style="margin-top:0px;float:top;position:absolute;margin-left:33.3%;"> <a href="">Informes</a>  
                    	 <ul>
                            <a href="admin/Informe_Ocupacion.php"><li style="">Ocupación</li></a>
                            <a href="admin/Informe_Reserva.php"><li>Reservas</li></a>
                            <a href="admin/Informe_Inventario.php"><li>Inventario</li></a>
                            <a href="admin/Consultas.php"><li>Datos</li></a>
                        </ul>
                    </li>
                   
                    <a href="admin/Mapa_Sitio.php" > <li  style="overflow:hidden;float:inherit;inline-box-align:initial;margin-left:50%;"> <i>Mapa del Sitio</i></li></a>
    ...
    <div id="cuerpo">
    	<div id="barra_vertical">
          <div id="foto" style="width: 50%; height: 43%; position: absolute; left: 20%; top: 34px; border: 1px solid #000;">
                ...
                ?>
                	<!-- InstanceBeginEditable name="imagen" --><?php if(!isset($_SESSION['correcto']) ){$portada='predeterminado.jpg';}else{$portada=$_SESSION['Foto'];} ?><img src="<?php echo '../usuario/'.$portada;?>" width="100%" height="100%" /><!-- InstanceEndEditable -->    
                <?php
                     }                
                ?>
           </div>
             ...
             <?php 
                		if(!isset($_SESSION['correcto']) ){
                         echo 'NO HAS INICIADO SESION!!';?>
   						<!-- InstanceBeginEditable name="NO_INICIADO" -->             		
                         <div id="no_session" style="position: absolute; width: 60px; height: 60px; margin-top: -60px; margin-left: -150px; background-image: url(Imagenes/ingresar.gif); background-repeat: no-repeat; background-size: 110% 100%; cursor: pointer; left: 205px; top: 173px;" onclick="Emergente_Login_Registro('admin/login.php')"></div>    
         ...
         <div id="area_trabajo">
		 <div id="formulario"><!-- InstanceBeginEditable name="formulario" --><!-- InstanceEndEditable --></div>
		 <!-- InstanceBeginEditable name="AREA_TRABAJO" -->
         <div style="position: absolute; width: 80%; height: 99%;background-image:url(Imagenes/inicio_1.jpg);background-repeat:no-repeat;background-size:100% 100%;margin-top:-30px;">
         </div>
<!-- InstanceEndEditable -->          
        </div>
    </div>
