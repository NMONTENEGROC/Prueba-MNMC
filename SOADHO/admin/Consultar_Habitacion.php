       ...
       <div id="TUPLAS" style="background-color:#FFF;width:98.3%;margin:0.5%;margin-top:240px;z-index:2;border:#003300 dashed 1px;border-radius:15px;padding:3px;">          
        <table width="98%" style="padding:1%;margin-left:1.3%;font-family:Lucida Sans Unicode;color:#000;border-collapse: collapse;" id="generar">
            	<tr style="width:100%;background: -webkit-gradient(linear, 0% 0%, 0% 100%, from(#9bbb40), to(#1e5b15));background: -moz-linear-gradient(top, #9bbb40, #1e5b15);">
                    ...
                    <td style="width:50%; text-align:center;padding-left:2%;">
                    	DESCRIPCION
                    </td>
                ...
                <?php 
					$ejecucion=$funciones->ejecutar("SELECT BQ.NOMBRE,HB.CODIGO,HB.DESCRIPCION,TF_D.VALOR AS DIARIA FROM HABITACION HB,BLOQUE BQ,TARIFA TF_D,TARIFA_HABITACION TH_D WHERE HB.ID_BLOQUE=BQ.ID_BLOQUE AND TH_D.ID_HABITACION=HB.ID_HABITACION AND TH_D.ID_TARIFA=TF_D.ID_TARIFA AND TF_D.TIPO='DIARIA'");
					$clase=2;
				...
				?>
                    ...
                    <td  style="padding-left:2%;border:#003300 dashed 1px"><?php echo $datos['CODIGO']; ?></td>
                    <td  style="padding-left:2%;border:#003300 dashed 1px"><?php echo $datos['DESCRIPCION']; ?></td>
                    <td  style="padding-left:2%;border:#003300 dashed 1px"><?php echo $datos['DIARIA']; ?></td>
                    </tr>
                 <?php  
				 	$clase=$clase+1;					
					}
