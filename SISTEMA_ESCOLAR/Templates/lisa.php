...
<tr>
                 <td width="191">
                 	<label name="Lb_usuario" id="label1"><b>Nombre</b></label></td>
                 <td width="179">
                 	<input type="text" name="Usuario" id="Usuario" class="text" required="required" placeholder="Nombre" />                 </td>
</tr>
<tr>
  <td><strong>Apellido</strong></td>
  <td><input type="text" name="Usuario2" id="Usuario2" class="text" required="required" placeholder="Apellido" /></td>
</tr>
<tr>
                 <td>
                 	<label name="Lb_Contraseña" id="label1"><b>Documento de Identidad </b></label></td>
                 <td>
                 	<input type="password" name="Contraseña_1" id="caja" class="text" required="required" placeholder="D.Identidad" />                 </td>
</tr>
<center>
<tr>
	<td colspan="2">
