   ...
   <td width="181" class="menu_b" style="border:1px solid #000033;"><div align="center"  style="text-align:center;text-decoration:none;"><a href="Creadores.php" class="menu_b" style="text-decoration:none;">CREADORES</a></div></td>
    ...
    <div id="Contenido">
		...
		<div id="Layer1" class="Estilo3">
		  <table width="344" height="221" border="0" style="border-radius:15px ;-webkit-box-shadow: -4px 7px 7px 1px #000; " cellspacing="0">
            <tr>
              <td>Asignatura</td>
              <td>
				 ...
				 $registro=mysql_fetch_array($result);
				  	?>
						<option value="<?php echo $registro['id_asignatura']; ?>"><?php echo $registro['NOMBRE'] ?></option>
					<?php
					$i=$i+1;
				 }
				 ?>
            ...
            <tr>
              <td>Valoración</td>
              <td>
                <input type="text" name="textfield" class="caja"/>
                     </td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>
                <input name="Submit" type="submit"  value="Ingresar"  class="BTN"/>
                          </td>
            </tr>
          </table>
		</div>
