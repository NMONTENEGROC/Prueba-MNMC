...
<div id="Cuerpo">
   ...
   <td width="181" class="menu_b" style="border:1px solid #000033;"><div align="center"  style="text-align:center;text-decoration:none;"><a href="Creadores.php" class="menu_b" style="text-decoration:none;">CREADORES</a></div></td>
    ...
    <div id="Contenido">
	   ...
	   echo 'HAS INICIADO SESION PARA INFORMATE ACERCA DE LOS DATOS DEL ESTUDIANTE '.$Nombre.' IDENTIFICADO CON DOCUMENTO DE IDENTIDAD NUMERO:  '. $documento;
	   ?>
	   <a href="../INCLUDES/DESTROY.php">CERRAR SESSION</a>
