...
#Layer3 {	position:absolute;
	...
	left: -117px;
       	...
       	Area_Trabajo         
       	Area_Trabajo         
       	Area_Trabajo         <!-- InstanceEndEditable -->
...
<div id="Cuerpo">
   ...
   <td width="181" class="menu_b" style="border:1px solid #000033;"><div align="center"  style="text-align:center;text-decoration:none;"><a href="Creadores.php" class="menu_b" style="text-decoration:none;">CREADORES</a></div></td>
    ...
    <div id="Contenido">
		...
		<div id="Layer1">
		  <p align="justify">Nacio el dia 30 de noviembre de 1996 en Santa Maria Boyaca su madre Maria Lilia Beltran de Santa Maria Boyaca y su padre Alonso Barrera de Santa Maria Boyaca se dedicaron al trabajo de agricultura y ganaderia, ellos siempre fueron cat&oacute;licos</p>
		  <p align="justify">Luisa estudi&oacute; en una vereda llamada Hormigueros en la Institucion Educativa Tecnica Jacinto Vega. Ella inici&oacute; sus estudios en el a&ntilde;o 2003, sus aspiraciones eran ser profesora escolar, y obtener un titulo. Ella termin&oacute; su primaria el 2008. Luego se traslador al municipio de Santa Maria (Boyac&agrave;) para terminar y lograr sus estudios, luego ella se interes&oacute; en estudiar Sistemas, pero para lograr sus estudios tuvo que trabajar y vivir en un restaurante por falta de recursos econ&oacute;micos en su familia.</p>
		  <p align="justify">Ella tuvo que sufrir para lograr sus estudios y siempre dijo &quot;Vivir con otra familia no es facil&quot; a ella se le presentaron muchos obstaculos como en el colegio como en el restaurante, ella asumio todo tipo de obstaculos. Habian momentos que no daba mas pero siempre decia que &quot;El &eacute;xito se logra con sacrificio&quot; sus amigos siempre le daban &aacute;nimo se seguir adelante y lograr lo que siempre so&ntilde;aba.</p>
		  <p align="justify">Actulmente le falta le falta poco para terminar su segunda etapa de sus estudios, so&ntilde;ando en ser una ingeniera de sistemas y poder ayudar a su familia... </p>
	    </div>
		<p>&nbsp;</p>
		<p>&nbsp;</p>
		<div id="Layer2">
		  <div id="Layer3">
            <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="465" height="60">
              <param name="movie" value="text30.swf" />
              <param name="quality" value="high" />
              <embed src="text30.swf" quality="high" pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="465" height="60" ></embed>
            </object>
          </div>
		  <img src="../IMAGENES/Captura.PNG" width="224" height="145" /></div>
		<p>&nbsp;</p>
