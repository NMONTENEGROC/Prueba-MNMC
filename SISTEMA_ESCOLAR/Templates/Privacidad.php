...
<div id="Cuerpo">
   ...
   <td width="181" class="menu_b" style="border:1px solid #000033;"><div align="center"  style="text-align:center;text-decoration:none;"><a href="Creadores.php" class="menu_b" style="text-decoration:none;">CREADORES</a></div></td>
    ...
    <div id="Contenido">
		...
		<p>&nbsp;</p>
		<div id="Layer2">
		  <p class="Estilo2">Este programa est&agrave; autorizado solo para manejo de la Coodinadora o los Adiministradores de la Instituci&ograve;n para modificar datos de los estudiantes.</p>
		  <p class="Estilo2">Este Programa no pueder ser editado ni suplantado </p>
		</div>
		<p>&nbsp;</p>
		<p>&nbsp;</p>
		<p>&nbsp;</p>
		...
		<p>&nbsp;</p>
		<p>&nbsp; </p>
		<div class="Estilo1" id="Layer1">PRIVACIDAD</div>
		<div id="Layer3"><img src="../IMAGENES/images-12.jpg" width="289" height="213" /></div>
