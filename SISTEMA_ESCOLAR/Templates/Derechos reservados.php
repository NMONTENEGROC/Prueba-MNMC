...
.Estilo3 {font-size: 25px}
.Estilo5 {font-family: Andalus; font-size: 70px; }
</style>
...
<div id="Cuerpo">
   ...
   <td width="181" class="menu_b" style="border:1px solid #000033;"><div align="center"  style="text-align:center;text-decoration:none;"><a href="Creadores.php" class="menu_b" style="text-decoration:none;">CREADORES</a></div></td>
    ...
    <div id="Contenido">
		...
		<div id="Layer3">
		  <div align="center"><strong><span class="Estilo5">DERECHOS RESERVADOS </span></strong></div>
		</div>
		<div id="Layer1">
		  <div align="justify" class="Estilo3">Este proyecto fue creado con el fin de poner en pr&aacute;ctica los conocimientos adquiridos durante los dos a&ntilde;os de estudios logrando obtener el t&iacute;tulo de T&eacute;cnicos en Sistemas c&eacute;rtificado por el SENA .</div>
		</div>
		<p>&nbsp;</p>
		<p>&nbsp;</p>
		<p>&nbsp;</p>
		...
		<p>&nbsp;</p>
		<p>&nbsp;</p>
		<div id="Layer2"><img src="../IMAGENES/images-1.jpg" width="370" height="201" /></div>
		<p>&nbsp;</p>
		<p>&nbsp;</p>
		<p>&nbsp;</p>
