...
<div id="Cuerpo">
   ...
   <td width="181" class="menu_b" style="border:1px solid #000033;"><div align="center"  style="text-align:center;text-decoration:none;"><a href="Creadores.php" class="menu_b" style="text-decoration:none;">CREADORES</a></div></td>
    ...
    <div id="Contenido">
		...
		<p>&nbsp;</p>
		<div id="Layer2">
		  <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="437" height="62">
            <param name="movie" value="text31.swf" />
            <param name="quality" value="high" />
            <embed src="text31.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="437" height="62"></embed>
          </object>
		</div>
		<div class="Estilo1" id="Layer3">
		  <p align="justify">La se&ntilde;orita, Yesika Lorena Aldana Vaca nacio el 5 de agosto de 1997 en San Luis De Gaceno (Boyaca), donde actualmente culmina sus estudios de secundaria. Su madre Nidia Consuelo Vaca Arias de Santa Maria (Boyaca) y su padre Luis Adolfo Aldana Vaca quien desarrollan diferentes actividaes. </p>
		  <p align="justify">Su aspiraciones para el a&ntilde;o 2015 es enpesar su carrera Univercitaria en - Ingenieria Ambiental en la ciudad de Bogota.</p>
		</div>
		<p>&nbsp; </p>
		<div id="Layer4"><img src="../IMAGENES/cvgh ijnhbgv hdvfgyb d.PNG" width="213" height="153" /></div>
